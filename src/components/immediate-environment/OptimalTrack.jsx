...
const OptimalTrack = () => {
  ...
  return (
    <>
      <div className='antialised relative m-0 mx-auto flex h-screen w-screen resize scroll-smooth p-0 text-base font-normal text-white'>
        <main className='mx-auto my-48 px-20 py-0 leading-4 text-gray-800' style={{ maxWidth: '794.88px' }}>
          ...
          <p className='mx-0 my-8 border-0 p-0 align-baseline text-2xl text-gray-800' style={{ lineHeight: '1.7' }}>
            Great turbulent clouds something incredible is waiting to be known Jean-François Champollion hundreds of
            thousands science hearts of the stars. another world brain is the seed of intelligence how far away bits of
            moving fluff realm of the galaxies? Cosmic fugue a still more glorious dawn awaits rings of Uranus dream of
            the eye not a sunrise but a galaxyrise the only home ever known.
          </p>
          <p className='mx-0 my-8 border-0 p-0 align-baseline text-2xl text-gray-800' style={{ lineHeight: '1.7' }}>
            Quasar intelligent beings cosmic ocean realm of the galaxies Jean-François Champollion descended from
            astronomers? . Star stuff harvesting star light inconspicuous motes of rock and gas the ash of stellar
            alchemy encyclopaedia galactica bits of moving fluff the only home ever known. Made in the interiors of
            collapsing stars the ash of stellar alchemy made in the interiors of collapsing stars not a sunrise but a
            galaxyrise made in the interiors of collapsing stars something incredible is waiting to be known.
          </p>
          <p className='mx-0 my-8 border-0 p-0 align-baseline text-2xl text-gray-800' style={{ lineHeight: '1.7' }}>
